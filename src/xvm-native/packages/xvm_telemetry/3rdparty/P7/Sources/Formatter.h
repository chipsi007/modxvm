...
#define FORMAT_DIGIT(i_uBase, i_pDigits, SIGN_MACRO, PREFIX_MACRO)\
    ...
    l_pTail   = l_pDigit;\
    *l_pDigit = TM('0');\
    if (l_uValue.u64) l_pDigit++;\
    while(l_uValue.u64)\
    {\
        *(--l_pDigit) = *(i_pDigits + (size_t)(l_uValue.u64 % i_uBase));\
        l_uValue.u64 /= i_uBase;\
    }\
...
//#define COPY_STR
                 ...
                 )
    {
        ...
        while(l_pArg)
        {
            ...
            {
                memcpy(&l_iWidth, i_pValues, min(SIZE_OF_ARG(tINT32), l_pP7Args->bSize));
            ...
            {
                memcpy(&l_iPrecision, i_pValues, min(SIZE_OF_ARG(tINT32), l_pP7Args->bSize));
                i_pValues += l_pP7Args->bSize; 
                l_pP7Args ++;
                if (0 > l_iPrecision)
                { l_iPrecision = 0; }
            ...
            if (eTypeIntDec == l_pArg->eType)
            {
                ...
                {
                    memcpy(&l_uValue.i64, i_pValues, sizeof(tINT64));
                }
                ...
                else //if (P7TRACE_ARG_TYPE_INT8 == l_pP7Args->bSize)
                {
                    tINT8 l_iVal;
            ...
            {
                l_uValue.u64 = 0ull;
                memcpy(&l_uValue.u64, i_pValues, g_pSize[l_pP7Args->bType]);
            ...
            else if (eTypeUintHEX == l_pArg->eType)
            {
                ...
                //while(l_uValue.u64)
                //{
                //    *(--l_pDigit) =*(g_pHEX + (size_t)(l_uValue.u64 % 16));
                //    l_uValue.u64 /= 16;
                //}
                //
                //l_szAdd       = (size_t)(l_pTail - l_pDigit + 1);
            ...
            else if (eTypeChar == l_pArg->eType)
            {
                ...
                {
                #ifdef UTF8_ENCODING
                    l_szReturn += (size_t)Convert_UTF16_To_UTF8((tWCHAR*)&l_uValue.u64, 
                                                                o_pBuffer + l_szReturn, 
                                                                (tUINT32)(i_szBuffer - l_szReturn)
                                                               );
                #else
                ...
                {
                #ifdef UTF8_ENCODING
                    l_szReturn += (size_t)Convert_UTF32_To_UTF8((tUINT32*)&l_uValue.u64,
                                                                o_pBuffer + l_szReturn, 
                                                                (tUINT32)(i_szBuffer - l_szReturn)
                                                               );
                #else
                    l_szReturn += (size_t)Convert_UTF32_To_UTF16((tUINT32*)&l_uValue.u64, 
                                                                o_pBuffer + l_szReturn, 
                                                                (tUINT32)(i_szBuffer - l_szReturn)
                                                               );
                #endif                             
            ...
            {
                l_uValue.u64 = 0ull;
                memcpy(&l_uValue.u64, i_pValues, l_pP7Args->bSize);
                l_iWidth -=2; //0x
                FORMAT_DIGIT(16ull, g_pHEX, FORMAT_NO_SIGN, FORMAT_X_PREFIX);
            }
